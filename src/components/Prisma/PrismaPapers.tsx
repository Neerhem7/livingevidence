...
const PrismaPapers: React.FC<PrismaPapersProps> = ({ activeTab }) => {
        ...
        <Col>
          <Card className="shadow-sm">
            <Card.Header className="d-flex align-items-center">
              ...
              Final number in quantitative synthesis (meta-analysis)
              <i className="fa-solid fa-magnifying-glass ms-auto"></i>
            </Card.Header>
